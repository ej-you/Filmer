...
func (this UserMovieHandlerManager) GetUserMovie() fiber.Handler {
	return func (ctx *fiber.Ctx) error {
		...
		err = this.userMovieUC.GetUserMovieByKinopoiskID(userMovie)
		if err != nil {
			return err
		}
...
func (this UserMovieHandlerManager) Stared() fiber.Handler {
	return func (ctx *fiber.Ctx) error {
		userMoviesWithCategory := &entity.UserMoviesWithCategory{Category: "stared"}
		return this.getMoviesWithCategory(ctx, userMoviesWithCategory)
	}
}
...
func (this UserMovieHandlerManager) Want() fiber.Handler {
	return func (ctx *fiber.Ctx) error {
		userMoviesWithCategory := &entity.UserMoviesWithCategory{Category: "want"}
		return this.getMoviesWithCategory(ctx, userMoviesWithCategory)
	}
}
...
func (this UserMovieHandlerManager) Watched() fiber.Handler {
	return func (ctx *fiber.Ctx) error {
		userMoviesWithCategory := &entity.UserMoviesWithCategory{Category: "watched"}
		return this.getMoviesWithCategory(ctx, userMoviesWithCategory)
	}
}
...
func (this UserMovieHandlerManager) getMoviesWithCategory(ctx *fiber.Ctx, userMoviesWithCategory *entity.UserMoviesWithCategory) error {
	var err error
	...
	userMoviesWithCategory.Filter = (*entity.UserMoviesFilter)(&dataIn.UserMoviesFilter)
	userMoviesWithCategory.Sort = (*entity.UserMoviesSort)(&dataIn.UserMoviesSort)
	userMoviesWithCategory.Pagination = (*entity.UserMoviesPagination)(&dataIn.UserMoviesPagination)

	// get user movies with given category and settings
	if err = this.userMovieUC.GetUserMoviesWithCategory(userMoviesWithCategory); err != nil {
		return err
	}
	return ctx.Status(200).JSON(userMoviesWithCategory)
}
